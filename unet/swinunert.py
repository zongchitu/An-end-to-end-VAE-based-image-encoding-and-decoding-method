...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        downsample="merging",
        use_v2=False,
        trigger_pretraining=False,
        vit: SwinTransformer = None,
    ) -> None:
        """
        Args:
        ...
        super().__init__()
        self.trigger_pretraining = trigger_pretraining
    ...
    def forward(self, x_in):
        ...
        logits = self.out(out)
        return (
            logits if not self.trigger_pretraining else [hidden_states_out[-1], logits]
        )
